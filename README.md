...
Links for all API pages are follows:  
Economic Times: https://abc-live-api.vercel.app/economic_times  
Moneycontrol: https://abc-live-api.vercel.app/moneycontrol  
Business Line: https://abc-live-api.vercel.app/business_line

**Note:** The original ABC Live API, which is no longer maintained, was written in Python. For ABC Live API in Python, click [here](https://github.com/Areen-Rath/ABC-Live-API-Old).